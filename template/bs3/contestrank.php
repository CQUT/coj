...
if($OJ_MEMCACHE){
  ?>
<a href="contestrank2.php?cid=<?php echo $cid?>" >回放</a>

<?php
}
 ?>
</center>
<table id=rank><thead><tr class=toprow align=center><td class="{sorter:'false'}" width=5%>排名<th width=10%>用户</th><th width=10%>昵称</th><th width=5%>正确数</th><th width=5%>用时</th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
