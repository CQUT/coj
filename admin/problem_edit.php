...
?>
<h1>Edit problem</h1>
<form method=POST action="https://coj.cqut.edu.cn/admin/problem_edit.php">
...
<p>Title:<input type=text name=title size=71 value='<?php echo htmlspecialchars($row->title)?>'>
...
echo "<a href='https://coj.cqut.edu.cn/problem.php?id=$id'>See The Problem!</a>";
}
?>
</body>
</html>
